# Iqbal, Rehmat Ali & Jinnah for Pakistan

**Section:** 2 — The Creation of Pakistan (1905–1947)
**Primary Topic #:** 29

_Added: Version 5 — user-created topic (2026-07-19), for ideological-contribution
questions about Allama Iqbal, Chaudhry Rehmat Ali, and Jinnah that don't fit the
other named Section 2 topics._

---

### UQID: PK2059-MJ-2011-V1-Q4C
...
- **Marks:** 14
- **Question (Verbatim):**
  > (c) Was the work of Allama Iqbal more important to the Pakistan Movement than that of Rehmat Ali? Explain your answer. [14]
- **Official Mark Scheme (Verbatim):**
  > LEVEL 1: Simplistic statement [1–2]
  > They both went to university.
  >
  > LEVEL 2: Description of each contribution [3–6]
  > Iqbal was a poet and was knighted by the British. He made a speech to the Muslim League in 1930. Ali came up with the name Pakistan.
  >
...
- **Audit Status:** Extracted from official mark scheme (MS only; source QP not separately supplied — question text taken verbatim as reprinted in MS). No dedicated topic existed for Iqbal/Rehmat Ali content; user directed creation of a new Section 2 topic (#29) rather than using the "Multiple Topic Questions (1927–1947)" catch-all or "Creation of the All-India Muslim League".
- **Version Number:** 5
