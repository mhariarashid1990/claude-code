...
- **Marks:** 14
- **Question (Verbatim):**
  > (c) Was anything achieved by the Round Table Conferences of 1930 to 1932?
  > Explain your answer.
- **Official Mark Scheme (Verbatim):**
  > LEVEL 1: Simplistic statement [1–2]
  ...
  >  Minorities entered into an agreement on their
  >  demands
...
- **Confidence Level:** N/A — allocated by direct user choice (clickable options), not auto-classified
- **Allocation Status:** Allocated
- **Audit Status:** Extracted from official mark scheme (MS only; source QP not separately supplied — question text taken verbatim as reprinted in MS). This is the May/June 2017 sitting of 2059/01. Reproduced in Cambridge's newer tabular mark scheme format. Topic chosen by user from clickable options.
- **Version Number:** 19
...
- **Confidence Level:** N/A — allocated by direct user choice (clickable options), not auto-classified
- **Allocation Status:** Allocated
- **Audit Status:** Extracted from official mark scheme (MS only; source QP not separately supplied — question text taken verbatim as reprinted in MS). This is the Oct/Nov 2018 sitting of 2059/01. First entry in this file on the Communal Award specifically, tied directly to the Second RTC's outcome. Source anomaly preserved verbatim: MS spells "Ramsey MacDonald" (commonly rendered "Ramsay MacDonald") — not corrected. Reproduced in Cambridge's newer tabular mark scheme format. Topic chosen by user from clickable options.
- **Version Number:** 22
