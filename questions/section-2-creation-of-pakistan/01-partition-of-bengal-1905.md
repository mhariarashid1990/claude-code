...
- **Audit Status:** Extracted from official mark scheme (MS only; source QP not separately supplied — question text taken verbatim as reprinted in MS). This is the Oct/Nov 2010 sitting of 2059/01. No exact-name topic exists for the Swadeshi Movement itself; user chose Partition of Bengal (1905) — the movement it arose directly from — over the "Multiple Topic Questions (1905–1926)" bucket. First entry in this topic file.
- **Version Number:** 10
