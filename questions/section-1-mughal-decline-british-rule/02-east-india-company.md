...
- **Marks:** 4
- **Question (Verbatim):**
  > With the slow crumbling of the Mughal Empire, the only question left in the early eighteenth century was who would pick up the pieces. Few observers could have guessed that the East India Company would have played such a major role.
  >
...
- **Secondary Tags:** Features, Founding
...
- **Marks:** 7
- **Question (Verbatim):**
  > (b) Why was Britain successful in maintaining its control of the sub-continent in the years 1750 to 1850?
- **Official Mark Scheme (Verbatim):**
  > LEVEL 1: Simplistic statement [1]
  > They were better fighters
  >
