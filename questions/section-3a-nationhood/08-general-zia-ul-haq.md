...
- **Marks:** 14
- **Question (Verbatim):**
  > (c) 'Islamic reforms were the most important of Zia-ul-Haq's domestic policies between 1977 and 1988.' Do you agree or disagree? Give reasons for your answer. [14]
- **Official Mark Scheme (Verbatim):**
  ...
  >
  > LEVEL 4: Explains at least two factors including Islamic laws (9–13)
...
- **Secondary Tags:** Domestic Policy, Religious, Comparison
- **Confidence Level:** Very High
- **Allocation Status:** Allocated
- **Audit Status:** Extracted from official mark scheme (MS only; source QP not separately supplied — question text taken verbatim as reprinted in MS per user confirmation). "Qafq Ordinances" reproduced exactly as printed in the source mark scheme (likely refers to the Qazf Ordinance) — not corrected, per verbatim rule.
- **Version Number:** 3
...
- **Official Mark Scheme (Verbatim):**
  ...
  > • It confirmed all previous acts of the martial law period with no right of appeal
  > • President could appoint Prime Minister, Governors of Provinces and other officials
...
- **Confidence Level:** N/A — allocated by direct user choice (clickable options), not auto-classified
- **Allocation Status:** Allocated
- **Audit Status:** Extracted from official mark scheme (MS only; source QP not separately supplied — question text taken verbatim as reprinted in MS). This is the Oct/Nov 2018 sitting of 2059/01. MS directly credits Zia with introducing it; the Eighth Amendment (1985) was already referenced within this file's May/June 2010 and Oct/Nov 2012 entries as background, but this is its first entry as the sole subject of a question. Reproduced in Cambridge's newer tabular mark scheme format. Topic chosen by user from clickable options.
- **Version Number:** 22
